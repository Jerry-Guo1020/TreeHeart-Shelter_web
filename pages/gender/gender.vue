    ...
    <view class="card">
      ...
      <view class="sex">
        <view class="boy" :class="{ active: gender === 'male' }" @tap="selectGender('male')">
          <image src="http://localhost:3000/static/男生.png" mode="aspectFill" class="boyLogo" :class="{ active: gender === 'male' }" />
          <view class="boyName">男生</view>
        </view>
        <view class="girl" :class="{ active: gender === 'female' }" @tap="selectGender('female')">
          <image src="http://localhost:3000/static/女生.png" mode="aspectFill" class="girlLogo" :class="{ active: gender === 'female' }" />
