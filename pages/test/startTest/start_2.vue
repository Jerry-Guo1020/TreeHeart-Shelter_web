  ...
  <view class="bg">
    <view class="intro-card">
      ...
      <view class="quiz-desc">
        ...
        需要时间 <text class="strong">10min</text> 左右
      </view>
      <!-- 按钮 -->
      <button class="start-btn" @tap="startQuiz">开始做题！</button>
    </view>
  </view>
</template>
...
onMounted(() => {
  console.log('ANXIOUS Start Page Mounted');
});
</script>
...
.start-btn {
  ...
  box-shadow: 0 2px 8px 0 #ffd9a044;
}
.start-btn:active {
  opacity: .8;
}
